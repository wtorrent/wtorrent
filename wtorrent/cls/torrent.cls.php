...
class torrent
{
	...
	*/
	...
	/* Sort functions */
	static function compareNameAscending($a, $b)
	{
		$an = $a->get_name();
		$bn = $b->get_name();
	...
	static function compareNameDescending($a, $b)
	{
		$an = $a->get_name();
		$bn = $b->get_name();
	...
	static function compareDLAscending($a, $b)
	{
		$an = $a->get_down_rate();
		$bn = $b->get_down_rate();
	...
	static function compareDLDescending($a, $b)
	{
		$an = $a->get_down_rate();
		$bn = $b->get_down_rate();
	...
	static function compareUPAscending($a, $b)
	{
		$an = $a->get_up_rate();
		$bn = $b->get_up_rate();
	...
	static function compareUPDescending($a, $b)
	{
		$an = $a->get_up_rate();
		$bn = $b->get_up_rate();
	...
	static function compareDoneAscending($a, $b)
	{
	...
	static function compareDoneDescending($a, $b)
	{
		$an = $a->get_completed_chunks() * $a->get_chunk_size();
		$bn = $b->get_completed_chunks() * $b->get_chunk_size();
	...
	static function compareSizeAscending($a, $b)
	{
		$an = $a->get_size_chunks() * $a->get_chunk_size();
		$bn = $b->get_size_chunks() * $b->get_chunk_size();
		
		return ($an > $bn) ? +1 : -1;
	}
	static function compareSizeDescending($a, $b)
	{
		$an = $a->get_size_chunks() * $a->get_chunk_size();
		$bn = $b->get_size_chunks() * $b->get_chunk_size();
	...
	static function comparePercentAscending($a, $b)
	{
	...
	static function comparePercentDescending($a, $b)
	{
		$an = $a->get_completed_chunks() / $a->get_size_chunks();
		$bn = $b->get_completed_chunks() / $b->get_size_chunks();
	...
	static function compareRatioAscending($a, $b)
	{
		$an = $a->get_ratio();
		$bn = $b->get_ratio();
	...
	static function compareRatioDescending($a, $b)
	{
		$an = $a->get_ratio();
		$bn = $b->get_ratio();
